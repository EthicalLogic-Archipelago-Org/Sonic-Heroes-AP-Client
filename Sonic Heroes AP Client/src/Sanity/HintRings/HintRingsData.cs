...
{
    public readonly struct HintRingData (Team team, LevelId levelid, string region, ushort voicelineid, byte linkid, float x = 0.0f, float y = 0.0f, float z = 0.0f)
    {
    ...
    {
        new HintRingData(team: Team.Dark, levelid: LevelId.SeasideHill, region: "Beginning Flower Patch", voicelineid: 27, linkid: 0, x: 24.45f, y: 190f, z: -1632.55f),
        new HintRingData(team: Team.Dark, levelid: LevelId.SeasideHill, region: "Eggmans Robots Bottom", voicelineid: 30, linkid: 0, x: -177.01f, y: 330f, z: -6675.51f),
